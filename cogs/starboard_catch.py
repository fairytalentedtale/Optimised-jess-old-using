...
# Poketwo shiny phrases all end with "... ✨"
# Exception: "These colors don't seem unusual..." is NOT shiny (it's the fake-out message)
def _is_shiny_message(content: str) -> bool:
    if "These colors don't seem unusual..." in content:
        return False
    return "... ✨" in content
...
class StarboardCatch(commands.Cog):
    ...
    def parse_poketwo_catch_message(self, message_content: str) -> dict:
        ...
        is_shiny = _is_shiny_message(message_content)
